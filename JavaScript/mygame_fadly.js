...
console.log("Welcome to the Virtual World " + player1.name + ". From now on, you are going to confront some series of choices to customize your own story ending. You are going to find out what kind of class/job you are end up with and your personalities. Let's go!");
...
// Fungsi dari kumpulan pertanyaan

function pertanyaan1() {
  console.log("Saat kamu membuka matamu, kamu berada di tengah keramaian. Banyak orang-orang di sekitar mu yang berjualan dan berteriak-teriak. Kamu berada di tengah keramaian pasar! Apa yang akan kamu lakukan pertama kali?");
  ...
  for(var i = 0; i < ask1.length; i++) {
    var j = i+1;
    console.log(j + ". " + ask1[i]);
  }
}

function pertanyaan2() {
  console.log("Setelah kamu mendapatkan informasi, ternyata kamu berada di kota bernama Lorden yang merupakan ibu kota dari kerajaan Lorsania. Karena kamu menghabiskan banyak waktu untuk mencari informasi, perutmu terasa lapar. Namun kamu tidak memiliki uang. Apa yang akan kamu lakukan selanjutnya?");
  ...
  for(var i = 0; i < ask2.length; i++) {
    var j = i+1;
    console.log(j + ". " + ask2[i]);
  }
}

function pertanyaan3() {
  console.log("Setelah kamu sampai di luar. Kamu di hampiri oleh seseorang yang baik hati dan menawarkanmu 3 macam senjata: pedang, panah dan tongkat penyembuh. Senjata mana yang kamu pilih?");
  var ask3 = ["Pedang", "Panah", "Tongkat Penyembuh"];
  for(var i = 0; i < ask3.length; i++) {
    var j = i+1;
    console.log(j + ". " + ask3[i]);
  }
}

function pertanyaan4() {
  console.log("Setelah beberapa lama kamu berburu, kamu melihat keramaian di kejauhan dan banyak orang yang melarikan diri. Ternyata ada monster raksasa (boss) yang sedang mengamuk ke arah kota. Apa yang akan kamu lakukan?");
  ...
  for(var i = 0; i < ask4.length; i++) {
    var j = i+1;
    console.log(j + ". " + ask4[i]);
  }
}

function pertanyaan5() {
  console.log("Kamu dan banyak orang lainnya berhasil menghalau monster tersebut dari kota. Banyak orang menghampirimu dan berterima kasih kepadamu atas pertolonganmu. Kamu sekarang lelah setelah lama berburu. Apa yang akan kamu lakukan selanjutnya?");
  ...
  for(var i = 0; i < ask5.length; i++) {
    var j = i+1;
    console.log(j + ". " + ask5[i]);
  }
}

// Menjalankan pertanyaan dan jawaban
// Bagaimana cara agar pertanyaan dan jawaban muncul secara sequence?
pertanyaan1();
jawaban1();
pertanyaan2();
jawaban1();
...
console.log("Terima kasih " + player1.name + " atas partisipasimu memainkan Part 1 dari game ini.");
console.log("Berdasarkan hasil sementara, inilah informasi mengenai dirimu: ");
console.log("Class kamu adalah: " + player1.job + ". " + player1.classInfo(player1.job));
console.log("Kamu adalah tipe personality: " + player1.personality + ". " + player1.charInfo(player1.personality));
