...
eastForestDivBtnNext.addEventListener("click", function() {
  ...
  endPanelText.innerHTML = "<img src='images/continue.png'>" + "<br/>" + "Thank you players for playing The Virtual Kingdom of Lorsania (Part 1)." + "<br/>" + "<br/>" + "This is not the end, but the beginning of the whole story. In the future, there will be lots of battle scene and the maps will be much bigger! (Part 2)" + "<br/>" + "<br/>" + "This is the result of your character until this point:  " + "<br/>" + "<br/>" + "Your Class: " + player1.job + ". " + player1.classInfo(player1.job) + "<br/>" + "<br/>" +"Your Personality: " + player1.personality + ". " + player1.charInfo(player1.personality);
