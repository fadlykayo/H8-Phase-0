...
function decoration() {
  ...
  pressKeyImg.setAttribute("src", "Lorsania_ver_2_Javascript/images/click.png");
...
marketDivBtnNext.addEventListener("click", function() {
  ...
  npcTagImg4.setAttribute("src", "Lorsania_ver_2_Javascript/images/stranger.png");
  npcTagImg5.style.display = "block";
  npcTagImg5.setAttribute("src", "Lorsania_ver_2_Javascript/images/stranger2.png");
  placeTagImg.style.display = "block";
  placeTagImg.setAttribute("src", "Lorsania_ver_2_Javascript/images/east_gate.png");
  bottomPanel.style.display = "block";
...
eastGateDivBtnNext.addEventListener("click", function() {
  ...
  box.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box.style.opacity = 0;
  box2.style.display = "block";
  box2.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box2.style.opacity = 0;
  box3.style.display = "block";
  box3.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box3.style.opacity = 0;
  box4.style.display = "block";
  box4.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box4.style.opacity = 0;
  box5.style.display = "block";
  box5.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box5.style.opacity = 0;
  box6.style.display = "block";
  box6.setAttribute("src", "Lorsania_ver_2_Javascript/images/treasure_chest.png");
  box6.style.opacity = 0;
  placeTagImg.style.display = "block";
  placeTagImg.setAttribute("src", "Lorsania_ver_2_Javascript/images/east_forest.png");
  bottomPanel.style.display = "block";
...
eastForestDivBtnNext.addEventListener("click", function() {
  ...
  endPanelText.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/continue.png'>" + "<br/>" + "Thank you for playing The Virtual Kingdom of Lorsania (Part 1)." + "<br/>" + "<br/>" + "This is not the end, but the beginning of the whole story. In the future, there will be lots of battle scene and the maps will be much bigger! (Part 2)" + "<br/>" + "<br/>" + "This is the result of your character until this point:  " + "<br/>" + "<br/>" + "Your Class: " + player1.job + ". " + player1.classInfo(player1.job) + "<br/>" + "<br/>" +"Your Personality: " + player1.personality + ". " + player1.charInfo(player1.personality) + " Credits: https://github.com/fadlykayo";
...
npcTagImg3.addEventListener("click", function() {
  ...
  optionBtn6.addEventListener("click", function () {
    ...
    optionBtn9.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/sword.png' class='option5'>";
    pDOM10.style.display = "block";
    optionBtn10.setAttribute("class", "button button-image position2");
    optionBtn10.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/bow.png' class='option6'>";
    pDOM11.style.display = "block";
    optionBtn11.setAttribute("class", "button button-image position3");
    optionBtn11.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/wand.png' class='option7'>";
...
npcTagImg4.addEventListener("click", function() {
  ...
  optionBtn18.addEventListener("click", function () {
    ...
    optionBtn12.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/heavy_armor.jpg' class='option8'>";
    pDOM13.style.display = "block";
    optionBtn13.setAttribute("class", "button button-image2 position5");
    optionBtn13.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/leather_armor.jpg' class='option8'>";
    pDOM14.style.display = "block";
    optionBtn14.setAttribute("class", "button button-image2 position6");
    optionBtn14.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/cloth_armor.jpg' class='option8'>";
    pDOM18.style.display = "none";
...
box.addEventListener("click", function() {
  if (repeatFlag === true) {
    ...
    optionBtn19.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/sword2.png'>";
    player1.equipment.push("Stinger Blade");
    attributSet();
  }
...
box2.addEventListener("click", function() {
  if (repeatFlag2 === true) {
    ...
    pDOM19.style.display = "block";
    optionBtn19.setAttribute("class", "tag button-image3 option1_1");
    optionBtn19.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/bow2.png'>";
    player1.equipment.push("Viper Bow");
    attributSet();
  }
...
box3.addEventListener("click", function() {
  if (repeatFlag3 === true) {
    ...
    pDOM19.style.display = "block";
    optionBtn19.setAttribute("class", "tag button-image3 option1_1");
    optionBtn19.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/wand2.png'>";
    player1.equipment.push("Netherbane Wand");
    attributSet();
  }
...
box4.addEventListener("click", function() {
  if (repeatFlag4 === true) {
    ...
    optionBtn19.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/gold.png'>";
    player1.gold += 5000;
    attributSet();
  }
...
box5.addEventListener("click", function() {
  if (repeatFlag5 === true) {
    ...
    optionBtn19.innerHTML = "<img src='Lorsania_ver_2_Javascript/images/potion_small.png'>";
