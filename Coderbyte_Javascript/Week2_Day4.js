...
var Teman = function(nama, kabar, pekerjaan) {
  ...
  this.sapa = function(nama2) { // nama2 = parameter yg berbentuk string, oleh karena itu butuh object.nama
    console.log("Halo " + nama2 + ", apa kabar?");
  };
  this.balasSapa = function(nama3) {
    console.log("Halo " + nama3 + ", kabarku " + this.kabar); // this.kabar = kabar dari object yang memanggil function balasSapa
  };
  ...
  }; // object.nama = nama dari object yg menjadi parameter
}

var budi = new Teman('Budi', 'baik', 'developer');
var tono = new Teman('Tono', 'kurang baik', 'chef');
